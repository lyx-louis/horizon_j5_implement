...
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
	...
	echo "Run $1"
	${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/ddr_isp0_1080p/vpm_config.json"  -r 10 \
	-x ${cam_rstart} -X ${vio_rstart} \
...
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
	...
	echo "Run $1"
	${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/ddr_isp0_pym0_1080p/vpm_config.json" -r 10 \
	-x ${cam_rstart} -X ${vio_rstart} \
...
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
	...
	do
		...
		${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/ddr_isp/$json"  -r 10 -M 3 \
		-x ${cam_rstart} -X ${vio_rstart} \
	...
	do
		...
		${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/ddr_isp/$json"  -r 10 -M 15 \
		-x ${cam_rstart} -X ${vio_rstart} \
		--gtest_filter=VpmIspTest.multi_isp_raw_feedback
	...
	do
		...
		${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/ddr_isp/$json"  -r 10 -M 255 \
		-x ${cam_rstart} -X ${vio_rstart} \
		--gtest_filter=VpmIspTest.multi_isp_raw_feedback
...
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
	...
	echo "Run $1"
	${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/ar0820_cim_isp0_4k/vpm_config.json" -r 10 -e 0 -c "/app/bin/vps/vpm/cfg/ar0820_cim_isp0_4k//hb_j5dev.json" \
	-x ${cam_rstart} -X ${vio_rstart} \
	--gtest_filter=VpmIspTest.vpm_isp_getdata \
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
...
elif test "$1" == "tx0_idu0yuv_hdmi_1080p"; then
	export GDC_MODULE_SKIP=1
	echo "Run $1"
	${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/tx/tx0_idu0yuv_hdmi_1080p/vpm_config.json"  -e 0  -r 1000 -c "/app/bin/vps/vpm/cfg/tx/tx0_idu0yuv_hdmi_1080p/hb_j5dev.json" \
	-x ${cam_rstart} -X ${vio_rstart} \
	--gtest_filter=VpmPymTest.vin_pym \
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml

elif test "$1" == "tx0_idu0yuv_hdmi_720p"; then
	export GDC_MODULE_SKIP=1
	echo "Run $1"
	${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/tx/tx0_idu0yuv_hdmi_720p/vpm_config.json"  -e 0  -r 1000 -c "/app/bin/vps/vpm/cfg/tx/tx0_idu0yuv_hdmi_720p/hb_j5dev.json" \
	-x ${cam_rstart} -X ${vio_rstart} \
	--gtest_filter=VpmPymTest.vin_pym \
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
...
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
	...
	echo "========= Run $1"
	${COMMON_DIR}vpm_gtest -v "/userdata/sunny_0233/dul_sen_cim_isp0_pym0_ws0820_ws0233/vpm_config.json" -S 1 -r 300000 -c "/userdata/sunny_0233/dul_sen_cim_isp0_pym0_ws0820_ws0233/hb_j5dev.json" -e 0 -M 3 \
	-x ${cam_rstart} -X ${vio_rstart} \
	--gtest_filter=VpmScenarioTest.multi_streams_pym \
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
...
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
	...
	echo "========= Run $1"
	${COMMON_DIR}vpm_gtest -v "./vpm_config.json" -e 0 -S 1 -r 300000  -c "./hb_j5dev.json" -M 15 \
	-x ${cam_rstart} -X ${vio_rstart} \
	--gtest_filter=VpmScenarioTest.multi_streams_pym \
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
...
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
	...
	export GDC_MODULE_SKIP=1
	echo "Run $1"
	${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/galaxy/galaxy_t01_vpgyuv_r3_cimdma_pym12_4k/vpm_config.json" -e 0 -r 10 -c "/app/bin/vps/vpm/cfg/galaxy/galaxy_t01_vpgyuv_r3_cimdma_pym12_4k/hb_j5dev.json" -M 3 \
	--gtest_filter=VpmScenarioTest.multi_streams_pym \
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
	...
	export GDC_MODULE_SKIP=1
	echo "Run $1"
	${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/galaxy/galaxy_t01_idu01yuv_r3_cimdma_pym2_1080p/vpm_config.json" -e 0 -r 10 -c "/app/bin/vps/vpm/cfg/galaxy/galaxy_t01_idu01yuv_r3_cimdma_pym2_1080p/hb_j5dev.json" -M 3 \
	--gtest_filter=VpmScenarioTest.multi_streams_pym \
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
...
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
	...
	export GDC_MODULE_SKIP=1
	echo "Run $1"
	${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/galaxy/galaxy_t0_vpgyuv4_r3_cimdma_pym2_1536p/vpm_config.json"  -e 0 -r 10 -c "/app/bin/vps/vpm/cfg/galaxy/galaxy_t0_vpgyuv4_r3_cimdma_pym2_1536p/hb_j5dev.json" -M 15 \
	-x ${cam_rstart} -X ${vio_rstart} \
	--gtest_filter=VpmScenarioTest.multi_streams_pym \
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
	...
	export GDC_MODULE_SKIP=1
	echo "Run $1"
	${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/galaxy/galaxy_t0_idu0yuv_r3_cimdma_pym2_1080p/vpm_config.json"  -e 0 -r 10 -c "/app/bin/vps/vpm/cfg/galaxy/galaxy_t0_idu0yuv_r3_cimdma_pym2_1080p/hb_j5dev.json" \
	-x ${cam_rstart} -X ${vio_rstart} \
	--gtest_filter=VpmPymTest.vin_pym \
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
	...
	export GDC_MODULE_SKIP=1
	echo "Run $1"
	${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/galaxy/galaxy_t1_idu1yuv_r3_cimdma_pym2_1080p/vpm_config.json" -e 0 -r 10 -c "/app/bin/vps/vpm/cfg/galaxy/galaxy_t1_idu1yuv_r3_cimdma_pym2_1080p/hb_j5dev.json" \
	-x ${cam_rstart} -X ${vio_rstart} \
	--gtest_filter=VpmPymTest.vin_pym \
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
	...
	export GDC_MODULE_SKIP=1
	echo "Run $1"
	${COMMON_DIR}vpm_gtest -v "/app/bin/vps/vpm/cfg/galaxy/galaxy_4v_t01_idu01yuv_r013_cim_cimdma_isp01_pym012_4k_1080p/vpm_config.json" -D 0x1803 -e 0 -r 10 -c "/app/bin/vps/vpm/cfg/galaxy/galaxy_4v_t01_idu01yuv_r013_cim_cimdma_isp01_pym012_4k_1080p/hb_j5dev.json" -M 15 \
	--gtest_filter=VpmScenarioTest.multi_streams_pym \
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
...
elif test "$1" == "5v_sunny0233"; then

	echo "========= Run $1"
	${COMMON_DIR}vpm_gtest -v "./vpm_config.json" -e 0 -S 1 -r 300000 -c "./hb_j5dev.json" -M 31 \
	-x ${cam_rstart} -X ${vio_rstart} \
	--gtest_filter=VpmScenarioTest.multi_streams_pym \
#	--gtest_output=xml:${OUTPUT_DIR_PREFIX}output/vps_$1_test_result.xml
