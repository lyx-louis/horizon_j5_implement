...
inference_module_save_img_from_roi_build_success
...
*/
    ...
    sprintf(fntmp_lf, "chnl_leftfront-%d-Infer_result.jpg", pym_id);
    cv::imwrite(fntmp_lf,mat_src_lf);
    ...
    char fntmp_f[1024] = {0};
    sprintf(fntmp_f, "chnl_roi_front-%d-Infer_result.jpg", pym_id);
    cv::imwrite(fntmp_f,mat_src_f);
    ...
    sprintf(fntmp_rf, "chnl_rightfront-%d-Infer_result.jpg", pym_id);
    cv::imwrite(fntmp_rf,mat_src_rf);
    ...
    sprintf(fntmp_lb, "chnl_leftback-%d-Infer_result.jpg", pym_id);
    cv::imwrite(fntmp_lb,mat_src_lb);
    ...
    rgb_input_list.emplace_back(mat_src_b);
        char fntmp_b[1024] = {0};
    sprintf(fntmp_b, "chnl_roi_back-%d-Infer_result.jpg", pym_id);
    cv::imwrite(fntmp_b,mat_src_b);
    ...
    sprintf(fntmp_rb, "chnl_rightback-%d-Infer_result.jpg", pym_id);
    cv::imwrite(fntmp_rb,mat_src_rb);
